          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
            {[
              ...
              <AnimateOnScroll key={item.label} animation="scale-in" delay={i * 100}>
                <div className="glass group flex flex-col items-center gap-3 rounded-2xl px-4 py-6 text-center transition-all duration-300 hover:bg-white/[0.06] hover:-translate-y-1">
